  ...
  return (
    <div className="about">
      ...
      <div className="aboutBottom">
        ...
        <p>
            Vision: Redefine the college experience through an innovative, community-oriented platform that becomes every student's instinctive choice when seeking assistance
